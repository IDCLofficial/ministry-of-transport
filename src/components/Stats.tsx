...
const stats = [
  { value: 56, suffix: "", desc: "Designated Bus Stops in Owerri" },
  { value: 1000, suffix: "+", desc: "Commercial Vehicles Registered" },
  { value: 24, suffix: "/7", desc: "Traffic Enforcement Hours" },
  { value: 500, suffix: "+", desc: "Transport Permits Issued" },
];
