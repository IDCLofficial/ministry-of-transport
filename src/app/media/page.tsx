...
export default function MediaPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#F7F9FA] flex flex-col">
      <MediaHeroSection
        title="Watch Us Transform the Transportation Sector"
        subtitle="Explore our gallery of photos, videos, and press releases showcasing our commitment to transforming the transportation sector in Imo State."
